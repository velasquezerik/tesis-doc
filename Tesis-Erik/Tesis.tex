...
\begin{enumerate}
	...
	\begin{equation}
		P{\tiny sig} = \begin{cases}P{\tiny prev} + |P{\tiny act} -P{\tiny prev}|/2\\P{\tiny prev} - |P{\tiny act}-P{\tiny prev}|/2\end{cases}
	\end{equation}
