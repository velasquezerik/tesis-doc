...
Para verificar el correcto funcionamiento de esta integración usando sockets, se definieron tres clientes o casos de pruebas distintos: Un cliente en lenguaje ``Python", un cliente en lenguaje ``C" y un lenguaje integrado en el sistema web de simulación.

\subsection{Cliente Python}

El cliente Python se desarrolló, para ejecutar cuatro instrucciones básicas del protocolo de comunicación: ``Start" comenzar la simulación, ``Set" modificar el valor de una variable dentro de la simulaci´on, ``Get" obtener el valor de una variable dentro de la simulación y ``Exit" terminar la simulación.
